...
$cutoff=$_POST['cutoff'];
$row1="INSERT INTO BRANCH(COLLEGE_ID,BRANCH_ID,BRANCH_NAME,BRANCH_CUTOFF) VALUES ('$id','$branchid','$branch','$cutoff')";
$row2="INSERT INTO college(COLLEGE_ID,COLLEGE_NAME,COLLEGE_STATE) VALUES ('$id','$name','$state')";
$row3="SELECT COLLEGE_ID from COLLEGE WHERE COLLEGE_ID='$id'";
$res2=0;
if($row3>0)
{
    $res1=mysqli_query($conn,$row1);
}
else
{
    $res1=mysqli_query($conn,$row1);
