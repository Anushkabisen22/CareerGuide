...
$bi=$_POST['bid'];
$ci=$_POST['cid'];
$row="DELETE FROM BRANCH WHERE COLLEGE_ID='$ci' AND BRANCH_ID='$bi' ";
...
<body>
    ...
    <br><br><br>
    <h3 style="margin-left: 47%;">Drop Branch</h3>
    <br>
    <br>
    <p><?php
    if($res==TRUE)
    {
        echo "Branch Dropped Successfully";
    }
    else
    {
        echo "Branch is not in the list" ;
    }?>
    </p>
    <!-- Optional JavaScript -->
